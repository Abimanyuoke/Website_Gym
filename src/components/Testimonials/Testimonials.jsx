    ...
    <div className='py-14 mb-10'>
        <div className='container'>
            ...
            <div className='text-left mb-10 max-w-[500px] space-y-2 mr-auto'>
                <h1 className="text-4xl font-bold capitalize">what are the customer saying about us</h1>
            </div>
            {/* Testimonials Cards */}
            <div>
                <Slider {...setting}>
                    {
                        TestimonialsData.map((data) => (
                            <div key={data.id} className='my-6'>
                                <div className='flex flex-col gap-4 p-8 shadow-lg mx-4 rounded-lg bg-primary/10'>
                                    {/* upper sections */}
